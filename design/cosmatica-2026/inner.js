...
if(!document.querySelector('link[data-logo-integrity]')){const li=document.createElement('link');li.rel='stylesheet';li.href='logo-integrity.css';li.dataset.logoIntegrity='true';document.head.appendChild(li)}
