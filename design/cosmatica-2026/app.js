(() => {
  ...
  document.querySelectorAll('[data-theme]').forEach(btn=>btn.addEventListener('click',()=>applyTheme(btn.dataset.theme)));document.querySelectorAll('[data-orbit-mode]').forEach(btn=>btn.addEventListener('click',()=>applyOrbitMode(btn.dataset.orbitMode)));
